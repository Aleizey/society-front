...
const Footer = () => {
    ...
    return (
        <>
            <div class="mt-8 bg-gray-100 border-t border-gray-200 text-black pt-9">
                <div class="mx-auto w-full max-w-[1166px] px-4 xl:px-0">
                        ...
                        <div class="md:w-[316px]">
                            <p class="text-[18px] font-medium ">
                                <h1 class=" font-extrabold">
                                    <span class="text-sky-500">SOCI</span>ETY
                                </h1>
                            </p>
                            <p class="mt-[18px] text-[15px] mb-6 font-normal /[80%]">Gestor de asociaciones online para todos los usuarios web, con tienda y eventos includos y mayor informacion sobre cada asociacion</p>
                        </div>
                        <div class="md:w-[316px]">
                            <div class=" flex">
                                ...
                                <div class="ml-[18px]">
                                    <a href="tel:+911800123444" class="font-Inter text-[14px] font-medium ">+34 623 456 789</a>
                                    <p class="font-Inter text-[12px] font-medium ">Support Number</p>
                                </div>
                            </div>
                            <div class="mt-[23px] flex">
                                ...
                                <div class="ml-[18px]">
                                    <a href="mailto:help@lorem.com" class="font-Inter text-[14px] font-medium ">alejandrovaldiviarey@gmail.com</a>
                                    <p class="font-Inter text-[12px] font-medium ">Support Email</p>
                                </div>
                            </div>
                            <div class="mt-[23px] flex">
                                <div class="flex h-[38px] w-[38px] items-center justify-center rounded-[75%]">
                                ...
                                <div class="ml-[18px]">
                                    <a href="mailto:help@lorem.com" class="font-Inter text-[14px] font-medium ">Calle Majada Marcial, 35630</a>
                                    <p class="font-Inter text-[12px] font-medium ">Address</p>
                                </div>
                            </div>
                        </div>
                        <div class="mt-6 flex w-full flex-col justify-between  sm:flex-row md:mt-0 md:max-w-[341px]">
                            <div class="">
                                <p class="text-deutziablack font-inter text-[18px] font-medium leading-normal">Pages</p>
                                <ul>
                                    <li class="mt-[15px]"><a
                                        class="text-deutziablack hover:text-deutziablack/80 font-inter text-[15px] font-normal hover:font-semibold"
                    ...
                    <hr class="mt-[30px] border-gray-300 " />
                    <div class="flex items-center justify-center pb-8 pt-[9px] md:py-2">
                        <p class="text-[10px] font-normal  md:text-[12px]">
                            © Copyright | Alejandro Valdivia | Adrian | @2025
                        </p>
                    </div>
                </div>
            </div>
