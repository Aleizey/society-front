...
const Footer = () => {
    ...
    return (
        <>
            <div className="mt-8 bg-gray-100 border-t border-gray-200 text-black pt-9">
                <div className="mx-auto w-full max-w-[1166px] px-4 xl:px-0">
                    <div className="flex flex-col justify-between sm:px-[18px] md:flex-row md:px-10">
                        <div className="md:w-[316px]">
                            <p className="text-[18px] font-medium ">
                                <h1 className=" font-extrabold">
                                    <span className="text-sky-500">SOCI</span>ETY
                                </h1>
                            </p>
                            <p className="mt-[18px] text-[15px] mb-6 font-normal /[80%]">Gestor de asociaciones online para todos los usuarios web, con tienda y eventos includos y mayor informacion sobre cada asociacion</p>
                        </div>
                        <div className="md:w-[316px]">
                            <div className=" flex">
                                ...
                                <div className="ml-[18px]">
                                    <a href="tel:+911800123444" className="font-Inter text-[14px] font-medium ">+34 623 456 789</a>
                            ...
                            <div className="mt-[23px] flex">
                                ...
                                <div className="ml-[18px]">
                                    <a href="mailto:help@lorem.com" className="font-Inter text-[14px] font-medium ">alejandrovaldiviarey@gmail.com</a>
                            ...
                            <div className="mt-[23px] flex">
                                ...
                                <div className="ml-[18px]">
                                    <a href="mailto:help@lorem.com" className="font-Inter text-[14px] font-medium ">Calle Majada Marcial, 35630</a>
                        ...
                        <div className="mt-6 flex w-full flex-col justify-between  sm:flex-row md:mt-0 md:max-w-[341px]">
                            <div className="">
                                <p className="text-deutziablack font-inter text-[18px] font-medium leading-normal">Pages</p>
                                <ul>
                                    <li className="mt-[15px]"><a
                                        className="text-deutziablack hover:text-deutziablack/80 font-inter text-[15px] font-normal hover:font-semibold"
                    ...
                    <div className="flex items-center justify-center pb-8 pt-[9px] md:py-2">
