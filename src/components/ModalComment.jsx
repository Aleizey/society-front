...
const ModalComment = ({ onClose, productos }) => {
                    ...
                    <form onSubmit={handleSubmit}>
                        ...
                        <div className="flex flex-row justify-between items-center border-t-1 pt-3 border-gray-300">
                            ...
                            <div className="row-end-6">
                                <button className="bg-sky-700 cursor-pointer text-white p-2 text-lg rounded-3xl px-10 w-full" type="submit">
                                    Enviar
                                </button>
                            </div>
                        </div>
                    </form>
                    <p className='text-red-500 w-full font-bold text-nowrap text-ellipsis overflow-hidden'>{status == "error" ? "Rellena todos los parametros" : ''}</p>
                </div>
            </div>
        </>
    );
