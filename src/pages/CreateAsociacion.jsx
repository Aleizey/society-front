                ...
                <div className="bg-white shrink-0 w-full md:w-110 md:h-auto h-screen self-start md:sticky fixed top-22 p-4 pt-2 z-2 md:flex flex-col ">
                    ...
                    <div className="">
                        <form className="space-y-4" onSubmit={handleSubmit}>
                            ...
                            <div>
                                <button className="cursor-pointer hover:bg-sky-300 transition-all w-full text-lg font-medium bg-sky-500 text-white p-1.5 rounded-4xl my-auto" type="submit">{status ? "cargando..." : "Crear"}</button>
                            </div>
                        </form>
                    </div>
                </div>
                <div className="bg-gray-200 w-full md:flex hidden justify-center items-start p-5 xl:p-20 xl:pt-10">
                    <div className="flex flex-col p-10 bg-white shadow-2xl rounded-2xl w-full">
                        <div className="text-xl font-medium flex flex-row items-center justify-between">
                            <p>Vista previa Asociación</p>
                            <span className="bg-sky-200 p-2 rounded-full">
                        ...
                        <div>
                            <img className="w-full h-70 object-cover rounded-xl" src="https://www.creativefabrica.com/wp-content/uploads/2023/02/02/Black-And-White-Drawing-Of-An-Ancient-Field-59810780-1.png" alt="imagen" />
                        </div>
                        <div className="py-4">
                            <Divider />
                        </div>
                        <div>
                            <p className="text-2xl">{asociaciones.nombre}</p>
                        ...
                        <div>
                            <div>
                                <ul className="grid grid-cols-3 text-center text-xl font-medium text-black/70">
                                    <li>General</li>
                                    <li>Tienda</li>
                                    <li>Información</li>
                                </ul>
                            ...
                            <div className="grid lg:grid-cols-2 grid-cols-1 gap-5 bg-gray-200 rounded-b-2xl p-4">
                                <div className="relative overflow-hidden bg-white rounded-2xl h-30">
                                    <img className="w-full h-full object-cover absolute" src="https://images.unsplash.com/photo-1703585221237-76dbdf3ae08a?fm=jpg&q=60&w=3000&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" alt="" />
                                    <div className="absolute font-bold text-3xl z-100 w-full h-full flex justify-start items-end p-4">
                                        <div className='flex flex-row font-bold space-x-3.5 items-center border-gray-200'>
                                            ...
                                            <div>
                                                ...
                                                <p className='font-normal  text-sm'>XXXX-XX-XX</p>
                                            </div>
                                            <div className="">
