                ...
                <>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8 mt-12 lg:px-8 ">
                        {asociaciones.map(dataAso => (
                            <Link to={`/asociacion/${dataAso.id}`} className="flex flex-col justify-between overflow-hidden w-full rounded-2xl text-black shadow-2xl" key={dataAso.id} >
                                <div>
                                ...
                                <div className="p-1">
                                    ...
                                    <div className="pt-2">
                                        <p className=" text-ellipsis text-gray-500 text-sm text-nowrap overflow-hidden "> <span className="font-medium">100</span> Miembros</p> {/* CAMBIAR */}
                                    </div>
