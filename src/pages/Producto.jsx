        ...
        <>
            ...
            <div className="">
                <div className="w-full px-4 py-8">
                    <div className="grid md:grid-cols-3 grid-cols-1 w-full -mx-4">

                        {/* Div de imagenes */}
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-2 relative px-4 mb-8 col-span-2">
                            <img src="https://images.unsplash.com/photo-1505740420928-5e560c06d30e?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NzEyNjZ8MHwxfHNlYXJjaHwxfHxoZWFkcGhvbmV8ZW58MHwwfHx8MTcyMTMwMzY5MHww&ixlib=rb-4.0.3&q=80&w=1080" alt="Product"
                                className="w-full h-full object-cover shadow-md" id="mainImage" />
                            <img src="https://images.unsplash.com/photo-1505740420928-5e560c06d30e?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NzEyNjZ8MHwxfHNlYXJjaHwxfHxoZWFkcGhvbmV8ZW58MHwwfHx8MTcyMTMwMzY5MHww&ixlib=rb-4.0.3&q=80&w=1080" alt="Product"
                                className="w-full h-full object-cover shadow-md" id="mainImage" />
                            <img src="https://images.unsplash.com/photo-1505740420928-5e560c06d30e?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NzEyNjZ8MHwxfHNlYXJjaHwxfHxoZWFkcGhvbmV8ZW58MHwwfHx8MTcyMTMwMzY5MHww&ixlib=rb-4.0.3&q=80&w=1080" alt="Product"
                                className="w-full h-full object-cover shadow-md" id="mainImage" />
                        ...
                        <div className="grid grid-cols-1 gap-0 overflow-y-hidden sticky min-h-min">
                            <div className="w-full h-[full] absolute">
                                ...
                                {/* Descripcion */}
                                <p className="text-gray-700 mb-6 w-full"> {datos.descripcion.toUpperCase()} </p>
                                    ...
                                    <div className="grid grid-cols-1 xl:grid-cols-2">
                                        <div className="">
                                            <input type="number" id="quantity" name="quantity" min="1" value="1"
                                                className="py-2 w-full text-center border border-gray-500 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50" />
