        ...
        <form onSubmit={submitForm}>
          ...
          <div className="mb-4">
            ...
            <div className="relative mt-1">
              <input type="email" name="email" id="email" className="block w-full h-10 pl-8 pr-3 mt-1 text-sm text-gray-700 border focus:outline-none rounded shadow-sm focus:border-blue-500" placeholder="user@xyz.com" value={email} onChange={event => setEmail(event.target.value)} required autoFocus />
