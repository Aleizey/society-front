...
function CreateProducto() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-sky-200 flex items-center justify-center py-12 px-4">
      <form 
        onSubmit={handleSubmit} 
        className="bg-white p-8 rounded-2xl shadow-2xl w-full max-w-md border border-gray-300"
      >
